...
<div class="container l-left">
	...
	<p>La presente Política de Privacidad establece los términos en que
		CEUS usa y protege la información que es proporcionada por sus
	...
	<p>Nuestro sitio web podrá recoger información personal por
		...
		electrónica y la dirección de Blockchain. Así mismo cuando sea
	...
	<p>CEUS está altamente comprometido para cumplir con el compromiso
	...
	<p>Nuestro sitio web emplea las cookies para poder identificar las
		...
		quiera y la proporcione directamente, visitas a una web. Usted puede
	...
	<p>En cualquier momento usted puede restringir la recopilación o el
		...
		opción de recibir nuestro boletín o publicidad usted puede cancelarla
	...
	<p>CEUS Se reserva el derecho de cambiar los términos de la
