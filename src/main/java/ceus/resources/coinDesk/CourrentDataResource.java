...
public class CourrentDataResource {
	...
	public String getValor(String mon) throws ResourceException, IOException {
		String res = null;
		...
		if (mon.equals("USD")) {
			...
			try {
				...
				Gson gson = new Gson();
				CourrentData cd = gson.fromJson(s, CourrentData.class);// gson.toJson(s, Bpi.class);//fromJson(s, Bpi.class);
